...
async def run():
    ...
    from cover_agent.lsp_logic.utils.utils_context import is_flask_todolist_app
    if is_flask_todolist_app(args.project_root):
        print("Detected Flask todolist app - enabling Flask optimizations")
        args.use_flask_optimizations = True
        ...
        for test_file in test_files:
            ...
            if source_file:
                try:
                    ...
                    args_copy.framework = getattr(args, 'framework', None)
                ...
                print(f"Could not determine source file for test file '{test_file}'. Skipping...")
